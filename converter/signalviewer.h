...
//generic
#define FWSAMPLERATEADC 256 //ReLax
#define FWSAMPLERATEACCX 4
#define FWSAMPLERATEACCY 4
#define FWSAMPLERATEACCZ 16
#define FWSAMPLERATETEMP 4
#define FWSAMPLERATETAG 4

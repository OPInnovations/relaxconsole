...
#define  FFTSIZE 512 //define the fft size ReLax
#define  FFTOVERLAP 256 //define the fft overlap ReLax
//M2  outside ReLax range
//#define  M2A 156.5
...
#define  M1C 124.5
#define  M1D 127.5  //C TO D  clamped for ReLax
//G2
#define  G2A 62.5
...
// for file conversion
#define FRMTSBEFORETHRES 345600 // if timestamp is 24 hours before previous, then accept and reset timestamp
#define FRMTSAFTERTHRES 345600 // if timestmap is 24 hours after previous, then accept and reset timestamp

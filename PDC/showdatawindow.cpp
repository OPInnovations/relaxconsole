...
void showdatawindow::reset(void)
{
    ...
    numScalefft=NUMPATHFFT/2; //256 bins, full 128Hz BW
...
void showdatawindow::on_timeSlider_valueChanged(int value)
{
    ...
    ui->timemorelabel->setText(QString("%1s").arg((ui->timeSlider->value())/256)); //divide by samplerate
}
...
void showdatawindow::on_FFT_TimeSlider_valueChanged(int value)
{
    ...
    QString temp;
    temp.setNum(value*256/NUMPATHFFT).append("Hz");

...
#define INITIALADC 1024  //ReLax 256Hz
#define INITIALFFT 256   //ReLax 256Hz
//define how many path(Points) you want to display
#define NUMPATHX 90
#define NUMPATHY 90
#define NUMPATHZ 360
#define NUMPATHTEMP 90
#define NUMPATHFFT 512  //2" ReLax, the value also means the sum of data you want to do FFT,do fft once every N times
#define FFTPENWIDTH 2 //set width of pen for fft
#define NUMPATHADC 15360 //initialize the max value of the timeSlider to be this to make sure the function work
...
#define TIMESLIDER_MIN_SAMPLE_POINTS 128 //should be times of NUMPOINTSAMPLE
